...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      project: "URLIFE LIFESTYLE WELLNESS LIMITED",
    ...
    },
    {
      ...
      duration: "2024 - Present",
      icon: <FaBuilding />,
      project: "Lifestyle Studio",
      description:
        "Lifestyle Studio is a fitness and wellness app for Lifestyle Fitness Studio, an Apollo Hospitals Group initiative, enabling users to book gym sessions, Zumba, aerobics, Pilates, and physiotherapy appointments, track memberships, and manage wellness programs on the go.",

      responsibilities: [
        "Built the Lifestyle Studio mobile app from scratch using React Native, covering gym booking, class scheduling, and membership management modules.",
        "Integrated REST APIs for real-time class availability, trainer schedules, and physiotherapy/rehab appointment booking.",
        "Implemented secure authentication, push notifications for class reminders, and offline data caching for uninterrupted usage.",
        "Designed a clean, intuitive UI for browsing amenities like gym equipment, Zumba, aerobics, Pilates, and Chandra Spa services.",
        "Managed end-to-end Play Store and App Store deployment including builds, signing, and production releases.",
      ],
    ...
    <section className="experience" id="experience">
      <div className="container">
        ...
        <div className="experience-header">
          <div className="section-tag">EXPERIENCE & EXPERTISE</div>
          ...
          <p className="experience-subtitle">
            Building scalable, secure, and high-performance applications across
            Fintech, Fitness, Healthcare, Education, and Event platforms.
          </p>
        </div>
        ...
        <div className="experience-grid">
          {domains.map((domain, index) => (
            ...
            >
              {/* ICON */}
              <div className="experience-icon">{domain.icon}</div>
        ...
        <div className="timeline-wrapper">
          <div className="timeline-heading">
            ...
            <p>
              My professional experience building scalable and production-grade
              mobile applications.
            </p>
          </div>
